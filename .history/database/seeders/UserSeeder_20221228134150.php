...
class UserSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    DB::table('user')->insert([
      ...
      'password' => '$2a$12$Cgs0pKnKNMMFtTuvhNzMW.k.EYSmiQ6pAARIAEemAzMRVF3JRcKBm',
    ]);
    ...
    DB::table('user')->insert([
      ...
      'password' => '$2a$12$IMJwNV.lWzTXvvo4sZFWAuenbc1uiHR3DUeuOorYd.b8agX5mBQYS',
    ]);
    ...
    DB::table('user')->insert([
      ...
      'password' => '$2a$12$0DmzYZlUAGHGM5hV0x6aEuQgCL1vrIAc0jL0u5kK8kxP5urgUokUK',
    ]);
    ...
    DB::table('user')->insert([
      ...
      'password' => '$2a$12$4/OOkvAUh6l764qNw8unWuqcMMCIG1ZsDA4T2.nRfmX8TiW0S79tS',
    ]);
    ...
    DB::table('user')->insert([
      ...
      'password' => '$2a$12$BPFjnXo0IEf1jsXPokGQN.uojXEu1NGMhgsJV024QaLkrkyCqxkWO',
    ]);
